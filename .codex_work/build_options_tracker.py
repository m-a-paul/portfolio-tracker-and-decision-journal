...
CURRENT_STOCK_POSITIONS = [
    {"ticker": "CASH", "shares": -1213.25, "price": 1.00, "avg_cost": 1.00, "notes": "Estimated free cash / buying power after reconciling known activity through 2026-06-09. Includes the user-reported $3,000 cash addition, which was not visible as a posted deposit in the CSV exports; confirm against broker buying power."},
...
CURRENT_OPTION_POSITIONS = [
    ...
    {"trade_id": 31, "strategy": "Long Call/Put", "status": "Open", "open_date": datetime(2026, 5, 26), "close_date": None, "ticker": "SONY", "asset": "Option", "action": "Buy", "option_type": "Call", "strike": 22.50, "expiration": datetime(2026, 12, 18), "qty": 5, "entry_price": 2.80, "exit_price": 2.80, "fees": 0, "notes": "Open SONY $22.50 calls per joint CSV.", "source": "Broker CSV"},
    {"trade_id": 32, "strategy": "Long Call/Put", "status": "Open", "open_date": datetime(2026, 5, 26), "close_date": None, "ticker": "SONY", "asset": "Option", "action": "Buy", "option_type": "Call", "strike": 22.50, "expiration": datetime(2027, 1, 15), "qty": 7, "entry_price": 2.77, "exit_price": 2.77, "fees": 0, "notes": "Open SONY $22.50 calls: 5 at $2.90 plus 2 at $2.45, weighted average about $2.77.", "source": "Broker CSV"},
